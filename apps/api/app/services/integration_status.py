...
INTEGRATION_DISPLAY: Dict[str, Dict[str, str]] = {
    ...
    "kimi_k2": {"name": "Kimi K2", "icon": "FaRobot"},
    "deepseek": {"name": "DeepSeek", "icon": "FaTerminal"},
    "glm": {"name": "Zhipu GLM", "icon": "FaTerminal"},
    "aider": {"name": "Aider", "icon": "FaTerminal"},
    "goose": {"name": "Goose", "icon": "FaFeather"},
