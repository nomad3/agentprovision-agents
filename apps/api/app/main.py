...
async def startup_desktop_control_preflight():
    from app.services.desktop_control_preflight import (
        startup_desktop_control_preflight as _startup_desktop_control_preflight,
    )

    await _startup_desktop_control_preflight()
