...
3. [Commands](#commands)
   - [`alpha login` / `alpha logout` / `alpha status`](#ap-login--ap-logout--ap-status)
   - [`alpha chat` — streaming + REPL](#ap-chat--streaming--repl)
   - [`alpha agent`](#ap-agent)
   - [`alpha workflow`](#ap-workflow)
   - [`alpha session`](#ap-session)
   - [`alpha memory`](#ap-memory)
   - [`alpha skill`](#ap-skill)
   - [`alpha integration`](#ap-integration)
   - [`alpha upgrade`](#ap-upgrade)
   - [`alpha completions`](#ap-completions)
   - [`alpha quickstart`](#ap-quickstart)
